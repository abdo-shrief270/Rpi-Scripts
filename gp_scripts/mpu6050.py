...
class MPU6050:
    ...
    def calibrate_sensors(self):
        print("Calibrating sensors... Keep the vehicle still!")
        print("This will take about 5 seconds.")
        
        # Initialize sums
        accel_sums = {'x': 0, 'y': 0, 'z': 0}
        gyro_sums = {'x': 0, 'y': 0, 'z': 0}
        samples = 500  # Increased samples for better accuracy
        ...
        print("Place the vehicle in its forward position and press Enter...")
        input()
